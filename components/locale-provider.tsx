...
const dictionaries: Record<Locale, Dict> = {
  "en-IN": {
    // Landing Page
    hero_title: "Your recovery journey starts here. Anonymous. Supportive. Free.",
    hero_sub: "RecoverPath helps you overcome addiction with AI support, peer accountability, and complete privacy. Your data never leaves your device.",
    cta_start: "Start Your Recovery",
    cta_privacy: "How your data stays private",
    go_to_dashboard: "Go to Recovery Hub",
    learn_more: "Learn More",
    private_secure: "100% Anonymous",
    always_available: "24/7 Support",
    encrypted: "E2E Encrypted",
    privacy_first: "Anonymous Recovery Support",
    cta_wellness_title: "Take Control of Your Life Today",
    cta_wellness_subtitle: "Join thousands in recovery who trust RecoverPath for their journey to freedom",
    trust_ondevice: "Complete anonymity - no tracking",
    trust_federated: "Peer support from real people in recovery",
    trust_encryption: "End-to-end encrypted conversations",
    trust_247: "24/7 AI recovery coach & crisis support",
    
    // Landing Page Features
    feature_ai_title: "Recovery Coach AI",
    feature_ai_desc: "Evidence-based support using CBT, DBT, and motivational interviewing - available 24/7",
    feature_dream_title: "Craving Pattern Analysis",
    feature_dream_desc: "Identify triggers and high-risk situations to prevent relapse",
    feature_peer_title: "Recovery Community",
    feature_peer_desc: "Connect anonymously with others fighting the same addiction - AA/NA style support",
    feature_relief_title: "Craving SOS Kit",
    feature_relief_desc: "Emergency tools when urges hit: grounding techniques, urge surfing, quick distraction",
    ...
    peer_search: "Find Recovery Partner",
    peer_chat: "Recovery Chat",
    professional_support: "Get Professional Help",
    settings: "Settings",
    nav_dashboard_desc: "Your recovery home",
    nav_peer_search_desc: "Find accountability partners",
    nav_professional_support_desc: "Connect with addiction counselors",
    nav_settings_desc: "Privacy & preferences",
    privacy_first_nav: "100% Anonymous",
    privacy_desc_nav: "All data is encrypted and anonymous",
    
    // Dashboard
    welcome_back: "Welcome back to recovery",
    welcome_subtitle: "Your recovery hub - tracking your journey to freedom",
    streak: "Days Clean",
    days_active: "Days in recovery",
    insights: "Patterns",
    insights_generated: "Identified",
    
    // Mood States (Recovery States)
    feeling_calm: "Feeling stable",
    feeling_anxious: "Feeling triggered",
    feeling_low: "Struggling today",
    feeling_lonely: "Need support",
    feeling_crisis: "Craving intense",
    
    mood_calm: "Stable",
    mood_anxious: "Triggered",
    mood_low: "Struggling",
    mood_lonely: "Need Support",
    mood_neutral: "Neutral",
    mood_stressed: "High Craving",
    mood_sad: "Down",
    mood_hopeful: "Hopeful",
    mood_confused: "Uncertain",
    
    // Mood Messages
    mood_msg_anxious_title: "Feeling triggered?",
    mood_msg_anxious_sub: "You've got this. Cravings pass. Let's ride this wave together.",
    mood_msg_low_title: "One day at a time",
    mood_msg_low_sub: "Every moment you resist is a victory. You're stronger than you know.",
    mood_msg_lonely_title: "You're not alone in this",
    mood_msg_lonely_sub: "Thousands are in recovery with you. Connect with your recovery community.",
    ...
    // Mood Indicator (Recovery State Indicator)
    ...
    how_feeling_today: "How's your recovery today?",
    save_checkin: "Save Commitment",
    checkin_saved: "Check-in saved!",
    
    // AI Companion (Recovery Coach AI)
    ai_companion: "Recovery Coach AI",
    ai_companion_desc: "24/7 evidence-based recovery support",
    ai_greeting: "Hey there! I'm your Recovery Coach. I'm here to support you through cravings, triggers, and every step of your recovery journey. How are you doing today?",
    ai_error: "I'm having trouble responding right now. But you're doing great just by reaching out. Please try again.",
    ai_timeout: "That took too long. Let's try a shorter message. Remember, you're stronger than any craving.",
    ai_network_error: "Network hiccup. Check your connection. While we reconnect, take 3 deep breaths.",
    ai_server_unavailable: "I'm temporarily unavailable, but your recovery community is still here. Try peer support or come back in a few minutes.",
    ai_rate_limited: "Take a breath - you're sending messages quickly. Slow down for a moment. I'm here when you're ready.",
    ai_invalid_response: "Something went wrong on my end. Your recovery is still on track. Please try again.",
    ai_no_response: "I couldn't respond. But YOU are responding by seeking help. That's huge. Try again.",
    start_chat: "Start Recovery Chat",
    chat_button: "Get Support",
    connecting: "Connecting to your coach...",
    type_message: "Share what you're feeling...",
    send: "Send",
    
    // Dream Analysis (Trigger Pattern Analysis)
    dream_analysis: "Trigger Pattern Analysis",
    dream_analysis_desc: "Identify your craving triggers and patterns",
    dream_title: "Pattern Recognition",
    dream_subtitle: "Understand what triggers your cravings",
    tell_dream: "Describe a recent craving or trigger",
    analyze_dream: "Analyze Pattern",
    analyzing: "Analyzing patterns...",
    dream_placeholder: "What triggered your last craving? Describe the situation, time, emotions, and people involved...",
    dream_empty_title: "No patterns tracked yet",
    dream_empty_desc: "Start tracking triggers and cravings to identify your high-risk patterns",
    ...
    // Micro Interventions / Quick Relief (Craving SOS Kit)
    micro_interventions: "Craving SOS Kit",
    micro_interventions_desc: "Emergency tools when urges hit",
    relief_breathing: "Urge Surfing (2min)",
    relief_grounding: "5-4-3-2-1 Grounding",
    relief_reflection: "Play The Tape Forward",
    duration_1min: "1 min",
    duration_2min: "2 min",
    duration_3min: "3 min",
    take_moment: "Use these tools anytime a craving hits",
    
    // Peer Search Page
    find_peer_title: "Find Recovery Partner",
    peer_anonymous_encrypted: "100% anonymous recovery support",
    online: "Online",
    searching_status: "Searching",
    community_status: "Recovery Community Status",
    realtime_availability: "Real-time recovery partners available",
    users_online: "In Recovery",
    in_search_queue: "Seeking Support",
    privacy_protected: "Your Anonymity is Guaranteed",
    privacy_protected_desc: "All conversations are encrypted end-to-end. Your identity remains completely anonymous. Connections are based on addiction type, recovery stage, and shared experiences.",
    how_feeling: "What's your recovery state?",
    select_mood_desc: "Select your current state to find compatible recovery partners",
    connection_need_level: "Support Need Level",
    connection_need_desc: "How much support do you need right now? (1-10)",
    just_browsing: "Just exploring",
    really_need_someone: "Need support urgently",
    interests_title: "Shared Interests & Activities",
    interests_desc: "Select interests to find recovery partners with similar hobbies",
    search_interests: "Search interests...",
    selected: "selected",
    no_interests_match: "No interests match your search",
    matching_tips: "Recovery Matching Tips",
    tip_honest: "Be honest about your state",
    tip_honest_desc: "Real recovery starts with honesty",
    tip_interests: "Share your interests",
    tip_interests_desc: "Connect over shared hobbies and passions",
    tip_available: "Stay available for a few minutes",
    tip_available_desc: "Matching usually takes 30-60 seconds",
    active_matches_title: "Active Recovery Connections",
    you_are_chatting: "You're currently connected with",
    chat_now: "Chat Now",
    no_active_matches: "No active connections",
    start_search: "Start a search to find your recovery partner",
    select_mood_first: "Please select your current recovery state",
    select_interest_first: "Please select at least one interest",
    no_matches_found: "No recovery partners found. Please try again later.",
    failed_peer_match: "Failed to find recovery partner. Please try again.",
    find_peer_connection: "Find a Recovery Partner",
  ...
  hi: {
    ...
    peer_chat: "साथी चैट",
    professional_support: "पेशेवर सहायता",
    settings: "सेटिंग्स",
    nav_dashboard_desc: "आपका कल्याण घर",
    nav_peer_search_desc: "साथी कनेक्शन खोजें",
    nav_professional_support_desc: "लाइसेंस प्राप्त चिकित्सकों से जुड़ें",
    ...
    ai_timeout: "अनुरोध में बहुत समय लग गया। कृपया छोटे संदेश के साथ पुनः प्रयास करें।",
    ai_network_error: "नेटवर्क त्रुटि। कृपया अपना कनेक्शन जांचें और पुनः प्रयास करें।",
    ai_server_unavailable: "AI सर्वर अस्थायी रूप से अनुपलब्ध है। कृपया बाद में पुनः प्रयास करें।",
    ai_rate_limited: "आप बहुत तेज़ी से संदेश भेज रहे हैं। कृपया प्रतीक्षा करें और पुनः प्रयास करें।",
    ai_invalid_response: "सर्वर से अमान्य प्रतिक्रिया प्राप्त हुई।",
    ai_no_response: "सर्वर से कोई प्रतिक्रिया नहीं। कृपया पुनः प्रयास करें।",
  ...
  bn: {
    ...
    professional_support: "পেশাদার সহায়তা",
    settings: "সেটিংস",
    nav_dashboard_desc: "আপনার সুস্থতার বাড়ি",
    nav_peer_search_desc: "সঙ্গী সংযোগ খুঁজুন",
    nav_professional_support_desc: "লাইসেন্সপ্রাপ্ত থেরাপিস্টদের সাথে সংযুক্ত হন",
    ...
    ai_timeout: "অনুরোধে অনেক সময় লেগেছে। অনুগ্রহ করে একটি ছোট বার্তা দিয়ে আবার চেষ্টা করুন।",
    ai_network_error: "নেটওয়ার্ক ত্রুটি। অনুগ্রহ করে আপনার সংযোগ পরীক্ষা করে আবার চেষ্টা করুন।",
    ai_server_unavailable: "এআই সার্ভার সাময়িকভাবে অনুপলব্ধ। অনুগ্রহ করে পরে আবার চেষ্টা করুন।",
    ai_rate_limited: "আপনি খুব দ্রুত বার্তা পাঠাচ্ছেন। অনুগ্রহ করে অপেক্ষা করুন এবং আবার চেষ্টা করুন।",
    ai_invalid_response: "সার্ভার থেকে অবৈধ প্রতিক্রিয়া পাওয়া গেছে।",
    ai_no_response: "সার্ভার থেকে কোন প্রতিক্রিয়া নেই। অনুগ্রহ করে আবার চেষ্টা করুন।",
  ...
  ta: {
    ...
    peer_chat: "சக அரட்டை",
    professional_support: "தொழில்முறை ஆதரவு",
    settings: "அமைப்புகள்",
    nav_dashboard_desc: "உங்கள் நல்வாழ்வு இல்லம்",
    nav_peer_search_desc: "சக இணைப்புகளைக் கண்டறியவும்",
    nav_professional_support_desc: "உரிமம் பெற்ற சிகிச்சையாளர்களுடன் இணைக்கவும்",
    ...
    ai_timeout: "கோரிக்கை நீண்ட நேரம் எடுத்தது. குறுகிய செய்தியுடன் மீண்டும் முயற்சிக்கவும்.",
    ai_network_error: "நெட்வொர்க் பிழை. உங்கள் இணைப்பைச் சரிபார்த்து மீண்டும் முயற்சிக்கவும்.",
    ai_server_unavailable: "AI சேவையகம் தற்காலிகமாக கிடைக்கவில்லை. பின்னர் மீண்டும் முயற்சிக்கவும்.",
    ai_rate_limited: "நீங்கள் மிக விரைவாக செய்திகளை அனுப்புகிறீர்கள். காத்திருந்து மீண்டும் முயற்சிக்கவும்.",
    ai_invalid_response: "சேவையகத்திலிருந்து தவறான பதில் பெறப்பட்டது.",
    ai_no_response: "சேவையகத்திலிருந்து பதில் இல்லை. மீண்டும் முயற்சிக்கவும்.",
  ...
  te: {
    ...
    peer_chat: "తోటి చాట్",
    professional_support: "వృత్తిపరమైన మద్దతు",
    settings: "సెట్టింగ్‌లు",
    nav_dashboard_desc: "మీ శ్రేయస్సు నివాసం",
    nav_peer_search_desc: "తోటి కనెక్షన్‌లను కనుగొనండి",
    nav_professional_support_desc: "లైసెన్స్ పొందిన థెరపిస్టులతో కనెక్ట్ అవ్వండి",
    ...
    ai_timeout: "అభ్యర్థన చాలా సమయం తీసుకుంది. చిన్న సందేశంతో మళ్లీ ప్రయత్నించండి.",
    ai_network_error: "నెట్వర్క్ లోపం. దయచేసి మీ కనెక్షన్ని తనిఖీ చేసి మళ్లీ ప్రయత్నించండి.",
    ai_server_unavailable: "AI సర్వర్ తాత్కాలికంగా అందుబాటులో లేదు. దయచేసి తర్వాత మళ్లీ ప్రయత్నించండి.",
    ai_rate_limited: "మీరు చాలా వేగంగా సందేశాలు పంపుతున్నారు. దయచేసి వేచి ఉండి మళ్లీ ప్రయత్నించండి.",
    ai_invalid_response: "సర్వర్ నుండి చెల్లని ప్రతిస్పందన అందుకుంది.",
    ai_no_response: "సర్వర్ నుండి ప్రతిస్పందన లేదు. దయచేసి మళ్లీ ప్రయత్నించండి.",
  ...
  mr: {
    ...
    professional_support: "व्यावसायिक समर्थन",
    settings: "सेटिंग्ज",
    nav_dashboard_desc: "तुमचे आरोग्य घर",
    nav_peer_search_desc: "सहकारी कनेक्शन शोधा",
    nav_professional_support_desc: "परवानाधारक थेरपिस्टशी कनेक्ट व्हा",
    ...
    ai_timeout: "विनंतीला बराच वेळ लागला. कृपया लहान संदेशासह पुन्हा प्रयत्न करा.",
    ai_network_error: "नेटवर्क त्रुटी. कृपया तुमचे कनेक्शन तपासा आणि पुन्हा प्रयत्न करा.",
    ai_server_unavailable: "AI सर्व्हर तात्पुरता अनुपलब्ध आहे. कृपया नंतर पुन्हा प्रयत्न करा.",
    ai_rate_limited: "तुम्ही खूप वेगाने संदेश पाठवत आहात. कृपया प्रतीक्षा करा आणि पुन्हा प्रयत्न करा.",
    ai_invalid_response: "सर्व्हरकडून अवैध प्रतिसाद प्राप्त झाला.",
    ai_no_response: "सर्व्हरकडून प्रतिसाद नाही. कृपया पुन्हा प्रयत्न करा.",
