    ...
    <Card className="overflow-hidden border-primary/10 shadow-md hover:shadow-lg transition-all duration-300">
      ...
      <CardContent className="p-4">
        <div className="flex flex-col gap-4">
          {/* Toggle Section */}
          <div className="flex items-center justify-between p-4 rounded-2xl border-2 border-border bg-card/50 transition-all duration-300 hover:border-primary/30 hover:shadow-md">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center h-11 w-11 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 shadow-lg shadow-purple-500/20 shrink-0">
                <Users className="h-5 w-5 text-white" />
              </div>
          ...
          {/* Info Badges */}
          <div className="flex items-center gap-2 p-3 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 shadow-sm">
            <div className="flex items-center justify-center h-7 w-7 rounded-lg bg-gradient-to-br from-primary to-primary/80 shadow-md shadow-primary/20 shrink-0">
              ...
              <div className="grid grid-cols-2 gap-2">
                {["Neutral", "Anxious", "Low", "Lonely"].map((mood) => (
                  <button
                    ...
                    className={`flex items-center justify-center p-3 rounded-xl border-2 transition-all shadow-sm ${
              ...
              {isSearching ? (
                ...
                <>
                  ...
                  <Button 
                    ...
                    className="w-full h-10 rounded-2xl border-primary/20 hover:bg-primary/5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
          ...
          {/* Privacy Notice */}
          <div className="flex items-center justify-center p-3 rounded-xl bg-muted/50 border">
