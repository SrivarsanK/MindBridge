        ...
        <div className="mb-8 md:mb-12 animate-in fade-in slide-in-from-top-4 duration-700">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0 overflow-hidden">
              ...
              <p className="text-sm text-muted-foreground mt-0.5 break-words">Your personal wellness sanctuary</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6">
            ...
            <div className="bg-card/50 backdrop-blur-sm border rounded-2xl p-4 hover:bg-card/80 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
              <div className="flex items-center gap-2 text-accent mb-1">
                ...
                <span className="text-xs font-medium whitespace-nowrap">Streak</span>
              </div>
              <p className="text-2xl font-bold">{streakData?.currentStreak ?? 0}</p>
              <p className="text-xs text-muted-foreground whitespace-nowrap">Days active</p>
            </div>
            <div className="bg-card/50 backdrop-blur-sm border rounded-2xl p-4 hover:bg-card/80 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
              <div className="flex items-center gap-2 text-primary mb-1">
                <Sparkles className="h-4 w-4 shrink-0" />
                <span className="text-xs font-medium whitespace-nowrap">Insights</span>
              </div>
              <p className="text-2xl font-bold">{insightsCount ?? 0}</p>
              <p className="text-xs text-muted-foreground whitespace-nowrap">Generated</p>
            </div>
          </div>
        </div>
