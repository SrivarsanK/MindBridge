...
export const enIN = {
  ...
  find_peer: "Find a Peer",
  
  // Insights
  insights_card: "Your Insights",
  insights_desc: "Personalized wellness insights",
  view_insights: "View Insights",
  
  // Micro Interventions
  micro_interventions: "Quick Relief",
  micro_interventions_desc: "5-minute mindfulness exercises",
